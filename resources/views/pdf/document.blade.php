<div class="pdf-page-outer" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:14px;">
			...
			<tr>
				...
				<th align="right" style="text-align:right;">
					<span style="font-weight:normal; font-size: 13px;">
						<p style="display: block;"><strong>Project</strong> {{ $projectName }} #{{ $projectNumber }}</p>
	...
	<table class="first-sec" cellpadding="0" cellspacing="0" style="width:100%">
		<tr>
			<td align="center" style="padding-bottom: 15px; padding-top: 30px;">
				<h2 style="font-size: 22px; font-weight: 600;">Job Safety Analysis</h2>
			</td>
		</tr>
		<tr>
	...
	<table class="row-second" cellpadding="0" cellspacing="0" style="width:100%">
		<tr>
			<td width="50%" style="font-size:12px; color:#000; border:1px solid #000; border-bottom:none; border-right:none; padding:10px;">
				<p>PIC</p>
				<p style="font-size: 14px;">{{ $pic }}</p>
			</td>
			<td width="50%" style="font-size:12px; color:#000; border:1px solid #000; border-bottom:none;  padding:10px;">
				<p>Phone</p>
				<p style="font-size: 14px;">{{ $phone }}</p>
			</td>
		</tr>
		<tr>
			<td width="50%" style="font-size:12px; color:#000; border:1px solid #000; border-right:none; padding:10px;">
				<p>SSE</p>
				<p style="font-size: 14px;">{{ $sse }}</p>
			</td>
			<td width="50%" style="font-size:12px; color:#000; border:1px solid #000;   padding:10px;">
				<p>Mentor</p>
				<p style="font-size: 14px;">{{ $mentor }}</p>
			</td>
		</tr>
	</table>
	...
	<table class="row-second" cellpadding="0" cellspacing="0" style="width:100%;border:none;">
		...
		<table class="row-second" cellpadding="0" cellspacing="0" style="width:100%;border:none; margin-top: 20px;">
			...
			<tr>
				<td width="50%" style="font-size:12px; color:#000; border:1px solid #000; border-top:none; border-right:none; border-top:none; padding:10px;">
					<p>Job Step
					<p>
					<p style="font-size: 14px;">{{ $job['step_title'] }}</p>
				</td>
				<td width="50%" style="font-size:12px; color:#000; border:1px solid #000; border-top:none; padding:10px;">
					<p>Person Responsible</p>
					<p style="font-size: 14px;">{{ $job['person_responsible'] }}</p>
				</td>
			</tr>
		</table>
		...
		<table class="row-third" cellpadding="0" cellspacing="0" style="width:100%; margin-top:20px;">
			...
			<tr>
				<td style="font-size:12px; color:#000; border:1px solid #000; border-right:none; border-top:none; padding: 10px;">
					<p>Hazard # {{$k+1}}</p>
					<p style="font-size: 14px;"> {{ $additional['hazard'] }}</p>
				</td>
				<td style="font-size:12px; color:#000; border:1px solid #000; border-top:none; padding:5px 10px;">
					<p>Control # {{ $k+1 }}</p>
					<p style="font-size: 14px;"> {{ $additional['control'] }}</p>
				</td>
			</tr>
			@endforeach
		</table>
		...
		<table class="job-steps-section" cellpadding="0" cellspacing="0" width="100%" style="width:100%; margin-top:20px; border:1px solid #000;">
			...
			<tr>
				<td colspan="2" style="background:#fff; border-top:1px solid #999; font-size:12px; color:#000; padding:10px;">
					<p>{{ $area }}</p>
				</td>
			</tr>
		</table>
		...
		<table class="job-steps-section" cellpadding="0" cellspacing="0" width="100%" style="width:100%; margin-top:0; border:1px solid #000;">
			...
			<tr>
				...
				<td style="background:#fff; border:1px solid #000; font-size:20px; color:#000; padding:10px;" align="center" valign="top">
					<p style="font-size: 36px;"><strong>Signature of Employees</strong></p><br /><img src="/storage/{{ $sign['signature'] }}"><br>
					<p style="font-size:30px;">{{ $sign['type_name'] }}</p>
				</td>
				@if($i%4 == 0)
			</tr>
			@endif

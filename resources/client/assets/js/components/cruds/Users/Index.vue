              ...
              <tr v-for="(user, index) in selectedUsers" v-bind:key="user.id">
                ...
                <td>
                  <select
                    ...
                    @change="e => handleAssignUserTitle(index, e)"
                  >
...
import DatatableUserCompany from '../../dtmodules/DatatableUserCompany'
...
export default {
  ...
  data() {
    return {
      columns: [
        ...
        { title: 'Company', field: 'company', tdComp: DatatableUserCompany },
  ...
  methods: {
    ...
    handleProjectRemove: function(e) {
      console.log("Removing is ready for this user")
    },
    showModal() {

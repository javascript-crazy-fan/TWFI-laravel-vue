...
import ProjectsSafety from './modules/Projects/safety'
import ProjectsSafetySingle from './modules/Projects/safetysingle'
import ProjectsSafetyCreate from './modules/Projects/safetycreate'
...
export default new Vuex.Store({
    modules: {
        ...
        ProjectsSingle,
        ProjectsSafety,
        ProjectsSafetySingle,
        ProjectsSafetyCreate,
        Auth,
        TimecardsIndex
    },
    strict: debug,

...
import ProjectsSafety from '../components/cruds/Projects/Safety.vue'
import ProjectsSafetyCreate from '../components/cruds/Projects/SafetyCreate.vue'
import ProjectsSafetyEdit from '../components/cruds/Projects/SafetyEdit.vue'
import ProjectsDailyReport from '../components/cruds/Projects/DailyReport.vue'
import ProjectsReportTime from '../components/cruds/Projects/ReportTime.vue'
...
const routes = [
	...
	{ path: '/projects/:id/reports/safety', component: ProjectsSafety, name: 'projects.safety' },
	{ path: '/projects/:id/safety/create/', component: ProjectsSafetyCreate, name: 'projects.safety.create' },
	{ path: '/projects/safety/:id/edit', component: ProjectsSafetyEdit, name: 'projects.safety.edit' },
	{ path: '/projects/:id/reports/daily', component: ProjectsDailyReport, name: 'projects.daily' },
	{ path: '/projects/:id/reports/time', component: ProjectsReportTime, name: 'projects.time' },
